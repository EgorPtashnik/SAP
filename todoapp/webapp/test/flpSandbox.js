		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TO DO",
									"targetURL": "#ypptashniktodoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypptashniktodoapp-display": {
								"semanticObject": "ypptashniktodoapp",
								"action": "display",
								"description": "Simple application for maintaining todo lists",
								"title": "TO DO",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yp.ptashnik.todoapp",
									"url": sap.ui.require.toUrl("yp/ptashnik/todoapp")
								}
							}
						}
					}
