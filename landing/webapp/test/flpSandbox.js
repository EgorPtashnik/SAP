					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Yahor Ptashnik",
									"targetURL": "#yplanding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yplanding-display": {
								"semanticObject": "yplanding",
								"action": "display",
								"description": "Yahor Ptashnik Landing Application",
								"title": "Yahor Ptashnik",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yp.landing",
									"url": sap.ui.require.toUrl("yp/landing")
								}
							}
						}
					}
